...
var _Vector = class _Vector extends Vector3d {
...
var _animationLoop = {
  nextFrame: /* @__PURE__ */ __name((cb) => requestAnimationFrame(cb), "nextFrame"),
  cancel: /* @__PURE__ */ __name((idx) => cancelAnimationFrame(idx), "cancel")
};
function getRandom() {
  const min = 0, max = 1;
...
__name(randomInRange, "randomInRange");
function getRangeValue(value) {
  return isNumber(value) ? value : randomInRange(value);
}
__name(getRangeValue, "getRangeValue");
function getRangeMin(value) {
  return isNumber(value) ? value : value.min;
}
__name(getRangeMin, "getRangeMin");
function getRangeMax(value) {
  return isNumber(value) ? value : value.max;
}
__name(getRangeMax, "getRangeMax");
...
__name(setRangeValue, "setRangeValue");
...
__name(getDistances, "getDistances");
...
__name(getParticleDirectionAngle, "getParticleDirectionAngle");
...
__name(getParticleBaseVelocity, "getParticleBaseVelocity");
...
__name(calcExactPositionOrRandomFromSize, "calcExactPositionOrRandomFromSize");
...
__name(hasMatchMedia, "hasMatchMedia");
...
__name(safeMatchMedia, "safeMatchMedia");
...
__name(safeIntersectionObserver, "safeIntersectionObserver");
...
__name(safeMutationObserver, "safeMutationObserver");
function isInArray(value, array) {
  const invalidIndex = -1;
  return value === array || isArray(array) && array.indexOf(value) > invalidIndex;
}
__name(isInArray, "isInArray");
function arrayRandomIndex(array) {
  return Math.floor(getRandom() * array.length);
}
__name(arrayRandomIndex, "arrayRandomIndex");
function itemFromArray(array, index, useIndex = true) {
  return array[index !== void 0 && useIndex ? index % array.length : arrayRandomIndex(array)];
}
__name(itemFromArray, "itemFromArray");
...
__name(executeOnSingleOrMultiple, "executeOnSingleOrMultiple");
function itemFromSingleOrMultiple(obj, index, useIndex) {
  return isArray(obj) ? itemFromArray(obj, index, useIndex) : obj;
}
__name(itemFromSingleOrMultiple, "itemFromSingleOrMultiple");
...
__name(initParticleNumericAnimationValue, "initParticleNumericAnimationValue");
...
__name(getPositionOrSize, "getPositionOrSize");
...
__name(computeFullScreenStyle, "computeFullScreenStyle");
...
__name(stringToRgba, "stringToRgba");
...
__name(rangeColorToRgb, "rangeColorToRgb");
...
__name(rangeColorToHsl, "rangeColorToHsl");
...
__name(stringToRgb, "stringToRgb");
...
__name(getRandomRgbColor, "getRandomRgbColor");
function getStyleFromRgb(color, opacity) {
  return `rgba(${color.r}, ${color.g}, ${color.b}, ${opacity ?? defaultOpacity})`;
}
__name(getStyleFromRgb, "getStyleFromRgb");
function getStyleFromHsl(color, opacity) {
  return `hsla(${color.h}, ${color.s}%, ${color.l}%, ${opacity ?? defaultOpacity})`;
}
__name(getStyleFromHsl, "getStyleFromHsl");
...
__name(getHslFromAnimation, "getHslFromAnimation");
...
__name(drawParticle, "drawParticle");
...
__name(drawShapeAfterDraw, "drawShapeAfterDraw");
...
__name(drawParticlePlugin, "drawParticlePlugin");
...
__name(setTransformValue, "setTransformValue");
...
__name(manageListener, "manageListener");
var _EventListeners = class _EventListeners {
  constructor(container) {
    ...
    this._handleWindowResize = () => {
      ...
      const handleResize = /* @__PURE__ */ __name(() => __async(this, null, function* () {
    ...
    this._handlers = {
      mouseDown: /* @__PURE__ */ __name(() => this._mouseDown(), "mouseDown"),
      mouseLeave: /* @__PURE__ */ __name(() => this._mouseTouchFinish(), "mouseLeave"),
      mouseMove: /* @__PURE__ */ __name((e) => this._mouseTouchMove(e), "mouseMove"),
      mouseUp: /* @__PURE__ */ __name((e) => this._mouseTouchClick(e), "mouseUp"),
      touchStart: /* @__PURE__ */ __name((e) => this._touchStart(e), "touchStart"),
      touchMove: /* @__PURE__ */ __name((e) => this._mouseTouchMove(e), "touchMove"),
      touchEnd: /* @__PURE__ */ __name((e) => this._touchEnd(e), "touchEnd"),
      touchCancel: /* @__PURE__ */ __name((e) => this._touchEnd(e), "touchCancel"),
      touchEndClick: /* @__PURE__ */ __name((e) => this._touchEndClick(e), "touchEndClick"),
      visibilityChange: /* @__PURE__ */ __name(() => this._handleVisibilityChange(), "visibilityChange"),
      themeChange: /* @__PURE__ */ __name((e) => this._handleThemeChange(e), "themeChange"),
      oldThemeChange: /* @__PURE__ */ __name((e) => this._handleThemeChange(e), "oldThemeChange"),
...
__name(_EventListeners, "EventListeners");
...
var _OptionsColor = class _OptionsColor {
  constructor() {
    this.value = "";
  }
...
__name(_OptionsColor, "OptionsColor");
var OptionsColor = _OptionsColor;

// node_modules/@tsparticles/engine/browser/Options/Classes/Background/Background.js
var _Background = class _Background {
  constructor() {
...
var _BackgroundMaskCover = class _BackgroundMaskCover {
  constructor() {
    this.opacity = 1;
  }
  load(data) {
...
__name(_BackgroundMaskCover, "BackgroundMaskCover");
var BackgroundMaskCover = _BackgroundMaskCover;

// node_modules/@tsparticles/engine/browser/Options/Classes/BackgroundMask/BackgroundMask.js
var _BackgroundMask = class _BackgroundMask {
  constructor() {
...
__name(_BackgroundMask, "BackgroundMask");
var BackgroundMask = _BackgroundMask;

// node_modules/@tsparticles/engine/browser/Options/Classes/FullScreen/FullScreen.js
var _FullScreen = class _FullScreen {
  constructor() {
    this.enable = true;
    this.zIndex = 0;
  }
...
__name(_ResizeEvent, "ResizeEvent");
var ResizeEvent = _ResizeEvent;
...
var _Interactivity = class _Interactivity {
  constructor(engine, container) {
...
__name(_Interactivity, "Interactivity");
var Interactivity = _Interactivity;

// node_modules/@tsparticles/engine/browser/Options/Classes/ManualParticle.js
var _ManualParticle = class _ManualParticle {
  load(data) {
    if (isNull(data)) {
      return;
    }
...
__name(_ManualParticle, "ManualParticle");
var ManualParticle = _ManualParticle;
...
var _Responsive = class _Responsive {
  constructor() {
...
__name(_Responsive, "Responsive");
var Responsive = _Responsive;
...
var _ThemeDefault = class _ThemeDefault {
  constructor() {
    this.auto = false;
...
__name(_ThemeDefault, "ThemeDefault");
var ThemeDefault = _ThemeDefault;
...
var _AnimationOptions = class _AnimationOptions {
  constructor() {
    this.count = 0;
    this.enable = false;
    this.speed = 1;
...
__name(_AnimationOptions, "AnimationOptions");
var AnimationOptions = _AnimationOptions;
var _RangedAnimationOptions = class _RangedAnimationOptions extends AnimationOptions {
  constructor() {
    super();
...
__name(_RangedAnimationOptions, "RangedAnimationOptions");
var RangedAnimationOptions = _RangedAnimationOptions;

// node_modules/@tsparticles/engine/browser/Options/Classes/ColorAnimation.js
var _ColorAnimation = class _ColorAnimation extends AnimationOptions {
  constructor() {
    super();
    this.offset = 0;
    this.sync = true;
...
__name(_ColorAnimation, "ColorAnimation");
var ColorAnimation = _ColorAnimation;

// node_modules/@tsparticles/engine/browser/Options/Classes/HslAnimation.js
var _HslAnimation = class _HslAnimation {
  constructor() {
...
__name(_HslAnimation, "HslAnimation");
var HslAnimation = _HslAnimation;

// node_modules/@tsparticles/engine/browser/Options/Classes/AnimatableColor.js
var _AnimatableColor = class _AnimatableColor extends OptionsColor {
  constructor() {
    super();
...
__name(_AnimatableColor, "AnimatableColor");
var AnimatableColor = _AnimatableColor;
...
var _CollisionsAbsorb = class _CollisionsAbsorb {
  constructor() {
    this.speed = 2;
  }
  load(data) {
...
__name(_CollisionsAbsorb, "CollisionsAbsorb");
var CollisionsAbsorb = _CollisionsAbsorb;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Collisions/CollisionsOverlap.js
var _CollisionsOverlap = class _CollisionsOverlap {
  constructor() {
    this.enable = true;
    this.retries = 0;
  }
...
__name(_CollisionsOverlap, "CollisionsOverlap");
var CollisionsOverlap = _CollisionsOverlap;

// node_modules/@tsparticles/engine/browser/Options/Classes/ValueWithRandom.js
var _ValueWithRandom = class _ValueWithRandom {
  constructor() {
    this.value = 0;
  }
  load(data) {
...
__name(_ValueWithRandom, "ValueWithRandom");
var ValueWithRandom = _ValueWithRandom;
var _AnimationValueWithRandom = class _AnimationValueWithRandom extends ValueWithRandom {
  constructor() {
    super();
...
__name(_AnimationValueWithRandom, "AnimationValueWithRandom");
var AnimationValueWithRandom = _AnimationValueWithRandom;
var _RangedAnimationValueWithRandom = class _RangedAnimationValueWithRandom extends AnimationValueWithRandom {
  constructor() {
    super();
...
__name(_RangedAnimationValueWithRandom, "RangedAnimationValueWithRandom");
var RangedAnimationValueWithRandom = _RangedAnimationValueWithRandom;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Bounce/ParticlesBounceFactor.js
var _ParticlesBounceFactor = class _ParticlesBounceFactor extends ValueWithRandom {
  constructor() {
    super();
    this.value = 1;
  }
};
__name(_ParticlesBounceFactor, "ParticlesBounceFactor");
var ParticlesBounceFactor = _ParticlesBounceFactor;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Bounce/ParticlesBounce.js
var _ParticlesBounce = class _ParticlesBounce {
  constructor() {
...
__name(_ParticlesBounce, "ParticlesBounce");
var ParticlesBounce = _ParticlesBounce;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Collisions/Collisions.js
var _Collisions = class _Collisions {
  constructor() {
...
var _MoveAngle = class _MoveAngle {
  constructor() {
    this.offset = 0;
    this.value = 90;
  }
...
__name(_MoveAngle, "MoveAngle");
var MoveAngle = _MoveAngle;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/MoveAttract.js
var _MoveAttract = class _MoveAttract {
  constructor() {
    this.distance = 200;
    this.enable = false;
    this.rotate = {
...
__name(_MoveAttract, "MoveAttract");
var MoveAttract = _MoveAttract;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/MoveCenter.js
var _MoveCenter = class _MoveCenter {
  constructor() {
    this.x = 50;
    this.y = 50;
...
__name(_MoveCenter, "MoveCenter");
var MoveCenter = _MoveCenter;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/MoveGravity.js
var _MoveGravity = class _MoveGravity {
  constructor() {
...
__name(_MoveGravity, "MoveGravity");
var MoveGravity = _MoveGravity;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/Path/MovePath.js
var _MovePath = class _MovePath {
  constructor() {
    this.clamp = true;
...
__name(_MoveTrailFill, "MoveTrailFill");
var MoveTrailFill = _MoveTrailFill;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Move/MoveTrail.js
var _MoveTrail = class _MoveTrail {
  constructor() {
    this.enable = false;
    this.length = 10;
...
__name(_MoveTrail, "MoveTrail");
var MoveTrail = _MoveTrail;
...
var _OpacityAnimation = class _OpacityAnimation extends RangedAnimationOptions {
  constructor() {
    super();
...
__name(_OpacityAnimation, "OpacityAnimation");
var OpacityAnimation = _OpacityAnimation;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Opacity/Opacity.js
var _Opacity = class _Opacity extends RangedAnimationValueWithRandom {
  constructor() {
    super();
...
__name(_ParticlesDensity, "ParticlesDensity");
var ParticlesDensity = _ParticlesDensity;
...
var _ParticlesNumberLimit = class _ParticlesNumberLimit {
  constructor() {
...
__name(_ParticlesNumberLimit, "ParticlesNumberLimit");
var ParticlesNumberLimit = _ParticlesNumberLimit;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Number/ParticlesNumber.js
var _ParticlesNumber = class _ParticlesNumber {
  constructor() {
...
__name(_ParticlesNumber, "ParticlesNumber");
var ParticlesNumber = _ParticlesNumber;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Shadow.js
var _Shadow = class _Shadow {
  constructor() {
    this.blur = 0;
    this.color = new OptionsColor();
    this.enable = false;
...
var _SizeAnimation = class _SizeAnimation extends RangedAnimationOptions {
  constructor() {
    super();
    this.destroy = DestroyType.none;
    this.speed = 5;
...
__name(_SizeAnimation, "SizeAnimation");
var SizeAnimation = _SizeAnimation;

// node_modules/@tsparticles/engine/browser/Options/Classes/Particles/Size/Size.js
var _Size = class _Size extends RangedAnimationValueWithRandom {
  constructor() {
    super();
...
__name(_ParticlesOptions, "ParticlesOptions");
var ParticlesOptions = _ParticlesOptions;
...
__name(loadOptions, "loadOptions");
function loadParticlesOptions(engine, container, ...sourceOptionsArr) {
  const options = new ParticlesOptions(engine, container);
  loadOptions(options, ...sourceOptionsArr);
  return options;
}
__name(loadParticlesOptions, "loadParticlesOptions");
...
__name(loadEffectData, "loadEffectData");
...
__name(loadShapeData, "loadShapeData");
  ...
  constructor(engine, container) {
    ...
    this._calcPosition = (container2, position, zIndex, tryCount = defaultRetryCount) => {
      ...
      const canvasSize = container2.canvas.size, exactPosition = calcExactPositionOrRandomFromSize({
        size: canvasSize,
        position
      }), pos = Vector3d.create(exactPosition.x, exactPosition.y, zIndex), radius = this.getRadius(), outModes = this.options.move.outModes, fixHorizontal = /* @__PURE__ */ __name((outMode) => {
        fixOutMode({
          outMode,
          checkModes: [OutMode.bounce],
          coord: pos.x,
          maxCoord: container2.canvas.size.width,
          setCb: /* @__PURE__ */ __name((value) => pos.x += value, "setCb"),
          radius
        });
      }, "fixHorizontal"), fixVertical = /* @__PURE__ */ __name((outMode) => {
        fixOutMode({
          outMode,
          checkModes: [OutMode.bounce],
          coord: pos.y,
          maxCoord: container2.canvas.size.height,
          setCb: /* @__PURE__ */ __name((value) => pos.y += value, "setCb"),
          radius
        });
      }, "fixVertical");
...
var _BaseRange = class _BaseRange {
...
var _Circle = class _Circle extends BaseRange {
...
var Circle = _Circle;
var _Rectangle = class _Rectangle extends BaseRange {
...
__name(_QuadTree, "QuadTree");
var QuadTree = _QuadTree;

// node_modules/@tsparticles/engine/browser/Core/Particles.js
var qTreeRectangle = /* @__PURE__ */ __name((canvasSize) => {
  const { height, width } = canvasSize;
  return new Rectangle(posOffset * width, posOffset * height, sizeFactor * width, sizeFactor * height);
}, "qTreeRectangle");
var _Particles = class _Particles {
  constructor(engine, container) {
  ...
  update(delta) {
    ...
    if (particlesToDelete.size) {
      const checkDelete = /* @__PURE__ */ __name((p) => !particlesToDelete.has(p), "checkDelete");
...
__name(initDelta, "initDelta");
function loadContainerOptions(engine, container, ...sourceOptionsArr) {
  const options = new Options(engine, container);
  loadOptions(options, ...sourceOptionsArr);
  return options;
}
__name(loadContainerOptions, "loadContainerOptions");
var _Container = class _Container {
  ...
  addClickHandler(callback) {
    ...
    const clickOrTouchHandler = /* @__PURE__ */ __name((e, pos, radius) => {
      if (!guardCheck(this)) {
        return;
      }
    ...
    }, "clickOrTouchHandler"), clickHandler = /* @__PURE__ */ __name((e) => {
      if (!guardCheck(this)) {
        return;
      }
    ...
    }, "clickHandler"), touchStartHandler = /* @__PURE__ */ __name(() => {
      if (!guardCheck(this)) {
        return;
      }
      touched = true;
      touchMoved = false;
    }, "touchStartHandler"), touchMoveHandler = /* @__PURE__ */ __name(() => {
      if (!guardCheck(this)) {
        return;
      }
      touchMoved = true;
    }, "touchMoveHandler"), touchEndHandler = /* @__PURE__ */ __name((e) => {
      if (!guardCheck(this)) {
        return;
      }
      ...
      touched = false;
      touchMoved = false;
    }, "touchEndHandler"), touchCancelHandler = /* @__PURE__ */ __name(() => {
      if (!guardCheck(this)) {
        return;
      }
      touched = false;
...
__name(getItemsFromInitializer, "getItemsFromInitializer");
...
__name(getDataFromUrl, "getDataFromUrl");
var getCanvasFromContainer = /* @__PURE__ */ __name((domContainer) => {
  let canvasEl;
  ...
  return canvasEl;
}, "getCanvasFromContainer");
var getDomContainer = /* @__PURE__ */ __name((id, source) => {
...
var _NgParticlesService = class _NgParticlesService {
...
__name(_NgParticlesService, "NgParticlesService");
__publicField(_NgParticlesService, "ɵfac", /* @__PURE__ */ __name(function NgParticlesService_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgParticlesService)();
}, "NgParticlesService_Factory"));
__publicField(_NgParticlesService, "ɵprov", ɵɵdefineInjectable({
  token: _NgParticlesService,
  factory: _NgParticlesService.ɵfac,
  providedIn: "root"
}));
var NgParticlesService = _NgParticlesService;
(() => {
...
var _NgxParticlesComponent = class _NgxParticlesComponent {
  platformId;
  particlesService;
  options;
  url;
  ...
  loadParticles() {
    const cb = /* @__PURE__ */ __name((container) => {
      this.container = container;
...
__name(_NgxParticlesComponent, "NgxParticlesComponent");
__publicField(_NgxParticlesComponent, "ɵfac", /* @__PURE__ */ __name(function NgxParticlesComponent_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxParticlesComponent)(ɵɵdirectiveInject(PLATFORM_ID), ɵɵdirectiveInject(NgParticlesService));
}, "NgxParticlesComponent_Factory"));
__publicField(_NgxParticlesComponent, "ɵcmp", ɵɵdefineComponent({
  ...
  vars: 1,
  consts: [[3, "id"]],
  template: /* @__PURE__ */ __name(function NgxParticlesComponent_Template(rf, ctx) {
    if (rf & 1) {
      ɵɵelement(0, "div", 0);
    }
    if (rf & 2) {
  ...
  }, "NgxParticlesComponent_Template"),
  encapsulation: 2
}));
var NgxParticlesComponent = _NgxParticlesComponent;
(() => {
...
var _NgxParticlesModule = class _NgxParticlesModule {
};
__name(_NgxParticlesModule, "NgxParticlesModule");
__publicField(_NgxParticlesModule, "ɵfac", /* @__PURE__ */ __name(function NgxParticlesModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgxParticlesModule)();
}, "NgxParticlesModule_Factory"));
__publicField(_NgxParticlesModule, "ɵmod", ɵɵdefineNgModule({
  type: _NgxParticlesModule,
  declarations: [NgxParticlesComponent],
  exports: [NgxParticlesComponent]
}));
__publicField(_NgxParticlesModule, "ɵinj", ɵɵdefineInjector({
  providers: [NgParticlesService]
}));
var NgxParticlesModule = _NgxParticlesModule;
(() => {
