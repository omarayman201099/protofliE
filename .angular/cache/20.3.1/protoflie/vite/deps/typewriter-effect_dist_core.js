    ...
    !(function(e, t) {
      ...
      var e = { 3146: (e2, t2, n2) => {
        ...
        if (!s || !u) {
          ...
          }, "s"), u = /* @__PURE__ */ __name(function(e3) {
        ...
        (function() {
          ...
          "undefined" != typeof performance && null !== performance && performance.now ? e2.exports = function() {
            ...
            return (t2() - a) / 1e6;
          }, n2 = process.hrtime, o = (t2 = /* @__PURE__ */ __name(function() {
            var e3;
            return 1e9 * (e3 = n2())[0] + e3[1];
          }, "t"))(), i = 1e9 * process.uptime(), a = o - i) : Date.now ? (e2.exports = function() {
            return Date.now() - r2;
      ...
      return (() => {
        "use strict";
        n.d(r, { default: /* @__PURE__ */ __name(() => C, "default") });
        var e2 = n(3146), t2 = n.n(e2);
        const o = /* @__PURE__ */ __name(function(e3) {
          return new RegExp(/<[a-z][\s\S]*>/i).test(e3);
        }, "o"), a = /* @__PURE__ */ __name(function(e3, t3) {
        ...
        const C = (function() {
          ...
          __name(n2, "n");
          var r2, g2;
          return r2 = n2, (g2 = [{ key: "init", value: /* @__PURE__ */ __name(function() {
            var e3, t3;
          ...
          }, "value") }, { key: "logInDevMode", value: /* @__PURE__ */ __name(function(e3) {
            this.options.devMode && console.log(e3);
          }, "value") }]) && A(r2.prototype, g2), Object.defineProperty(r2, "prototype", { writable: false }), n2;
        })();
      })(), r.default;
    })()));
  }
